  ...
  },
{
  ...
  slug: "food-delivery",
  shortDescription: "اطلب من أي مطعم تريده وسأقوم بشراء الطلب وتوصيله.",
  description:
    "خدمة توصيل طلبات الطعام من مطعم يحدده العميل. يتم احتساب السعر النهائي على أساس قيمة الطلب الفعلية من المطعم مضافًا إليها رسوم التوصيل.",
